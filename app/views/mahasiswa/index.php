                ...
                <form action="<?= BASEURL; ?>/mahasiswa/tambah" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="jurusan" name="jurusan">
                            ...
                            <option value="Teknik Assassin">Teknik Assassin</option>
                            <option value="Teknik Marksman">Teknik Marksman</option>
                            <option value="Teknik Mage">Teknik Mage</option>
                            <option value="Teknik Tank">Teknik Tank</option>
                            <option value="Teknik Support">Teknik Support</option>
                        </select>
                    </div>
